...
At first, we used our mounted camera too follow walls. This worked out great for the open challenge and seemed to work well for our obstacle challenge at first, but we soon found some cases in which the robot would spin out of control with our camera wall following. Take this case for example.
